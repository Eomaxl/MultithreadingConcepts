...
/**
 * Introduction to blocking queue (FIFO -First In First Out)
 * Blocking queue interface
 *  ==> BlockingQueueDemo (Blocking Deque, TransferQueue)
 * Major implementations (ArrayBlockingQueue, LinkedBlockingQueue, PriorityBlockingQueue, DelayQueue, SynchronousQueue)
 * Blocking Queue Operations ( put(E e), task(), offer(E e), poll(), peek() )
 * */
